...
public class BluetoothActivity_distance extends Activity
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnSend: {
                ...
                String url = "http://arcreation.xyz/pulsei/insert_distance.php";

                Map<String, Object> params = new HashMap<String, Object>();
                params.put("distance_count", String.format("%.2f", Double.valueOf(result_step*0.7)));
                    ...
                    public void callback(String url, String html, AjaxStatus status) {
                        try {
                            ...
                            if ("9999".equals(object.getString("result_code"))) {
                                ...
                                intent.putExtra("data_digit", (result_step * 0.7 + ""));
