...
public class BluetoothActivity2 extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bluetooth_layout2);
        aq = new AQuery(this);
        ...
        bluetooth_heart_tv = (TextView)findViewById(R.id.bluetooth_heart_tv);
        // ListView 초기화
        initListView();
        ...
        public void run() {
            {
                ...
                while (true) {
                    try {
                        ...
                        mHandler.obtainMessage(BluetoothActivity2.MESSAGE_READ, bytes, -1, buffer).sendToTarget();
    ...
    class buttonThread extends Thread {
        ...
        public void run() {
            super.run();
            while (isPlay) {
                if (strBuf != null && strBuf.contains("B")) {
                    String value = strBuf.substring(strBuf.indexOf('B') + 1);
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            bluetooth_heart_tv.setText("박동수 : " + heart);
                        }
                    });
                }
            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnSend: {
                ...
                String url = "http://arcreation.xyz/pulsei/insert_heart.php";

                final int heart_final = (int)(heart_add/heart_count);
                showMessage("heart_add = " + heart_add);
                showMessage("heart_count = " + heart_count);
                Map<String, Object> params = new HashMap<String, Object>();
                params.put("heart_count", heart_final);
                    ...
                    public void callback(String url, String html, AjaxStatus status) {
                        try {
                            ...
                            if("9999".equals(object.getString("result_code"))){
                                ...
                                intent.putExtra("data_digit", heart_final+"");
